...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['Find a hot princess', 'Sit back and relax'];
    progressListArray = ['Enter the Kessel Run', 'Make it in 12 parsecs'];
    completeListArray = ['Be the best pilot', 'Avoid Female Advice'];

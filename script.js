...
function getSavedColumns() {
  if (localStorage.getItem("backlogItems")) {
    ...
    backlogListArray = ["Work on Death Star", "Retake the high ground"];
    progressListArray = ["Lightsaber Practice"];
    completeListArray = ["Destroy a distant planet"];
    onHoldListArray = ["Being good"];
  }
}
